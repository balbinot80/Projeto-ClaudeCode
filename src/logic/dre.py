...
MAPA_CATEGORIAS: dict[str, str] = {
    ...
    "cursos":               "4.12.1 Cursos/Treinamentos",
    "treinamento":          "4.12.1 Cursos/Treinamentos",
    "mentoria":             "4.12.1 Cursos/Treinamentos",
    "curso":                "4.12.1 Cursos/Treinamentos",
...
ORDEM_DRE: list[tuple[str, str]] = [
    ...
    ("4.12.1 Cursos/Treinamentos",  "    └ Cursos e Treinamentos"),
